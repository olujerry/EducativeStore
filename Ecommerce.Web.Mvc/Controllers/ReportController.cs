...
public class ReportController : Controller
{
    ...
    public ReportController(IMediator mediator, IMapper mapper, IWebHostEnvironment webHostEnvironment, IKeyAccessor keyAccessor)
    {
        _mediator = mediator;
        _mapper = mapper;
    ...
    [HttpGet]
    [Route("order-invoice/{invoiceNo}")]
    public async Task<IActionResult> OrderInvoice(string invoiceNo)
    {
        if (invoiceNo == null) return NotFound();
